...
if [ ! -d "Fedora-post-install" ] && [ ! -f "main.sh" ]; then
    # If the directory and main script don't exist, run main function
    main
else
    # If files/folders exist, assume it's not the first run
    echo "Fedora post-install files already exist. Skipping initial setup."
fi
